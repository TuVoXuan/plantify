    ...
    if (totalPageCount <= maxVisiblePages) {
      for (let i = 1; i <= totalPageCount; i++) {
        items.push(
          <PaginationItem key={i}>
            <PaginationLink className={classNameItemLink} href={buildLink(i)} isActive={page === i}>
              {i}
            </PaginationLink>
          </PaginationItem>,
        );
      ...
      items.push(
        <PaginationItem key={1}>
          <PaginationLink className={classNameItemLink} href={buildLink(1)} isActive={page === 1}>
            1
          </PaginationLink>
        </PaginationItem>,
      );
        ...
        <PaginationContent className="max-sm:gap-0">
          <PaginationItem>
            <PaginationLink
              ...
              className={cn(page === 1 ? "pointer-events-none opacity-50" : undefined, classNameItemLink)}
            >
              <ChevronLeft />
            </PaginationLink>
            {/* <PaginationPrevious
          ...
          <PaginationItem>
            <PaginationLink
              ...
              className={cn(page === totalPageCount ? "pointer-events-none opacity-50" : undefined, classNameItemLink)}
            >
              <ChevronRight />
            </PaginationLink>
            {/* <PaginationNext
